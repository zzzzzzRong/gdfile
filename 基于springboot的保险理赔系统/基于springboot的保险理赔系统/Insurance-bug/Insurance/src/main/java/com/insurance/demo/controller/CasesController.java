...
public class CasesController {
    ...
    @GetMapping("insert")
    public Cases insert(HttpServletRequest request,Integer userId, Integer insId, Integer markId, String accidentTime, String accidentAreaid, String userName, String userPhone, String carType, String details, Integer type, String cause, Integer reviewId, String reviewName, Integer committee) {
        Cases cases = new Cases(userId,insId,markId,accidentTime,accidentAreaid,userName,userPhone,carType,details,type,cause,reviewId,reviewName,committee,new Date());
        this.casesService.insert(cases);
        return cases;
    }

    @GetMapping("update")
    public Cases update(int id,HttpServletRequest request, Integer userId, Integer insId, Integer markId, String accidentTime, String accidentAreaid, String userName, String userPhone, String carType, String details, Integer type, String cause, Integer reviewId, String reviewName, Integer committee) {
        Cases cases = new Cases(userId,insId,markId,accidentTime,accidentAreaid,userName,userPhone,carType,details,type,cause,reviewId,reviewName,committee,new Date());
        cases.setId(id);
...
//        c.setReviewName(review.getName());
    ...
    public DataVo queryAllByLimit(int page, int limit) {
        ...
        try {
            List<Cases> cases = casesService.queryAllByLimit((page - 1) * limit, limit);
