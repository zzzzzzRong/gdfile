...
public class CasesController {
    ...
    @GetMapping("update")
    public Cases update(int id, Integer userId, Integer insId, Integer markId, String accidentTime, String accidentAreaid, String userName, String userPhone, String carType, String details, Integer type, String cause, Integer reviewId, String reviewName, Integer committee) {
